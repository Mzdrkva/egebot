...
async def cmd_start(msg: types.Message):
    ...
    instruction = (
        "👋 Добро пожаловать!\n\n"
        "📋 Инструкция:\n"
        "1) Нажмите «✅ Сданные предметы ЕГЭ», чтобы просмотреть и отредактировать ваши предметы (русский добавлен автоматически).\n"
        "2) В режиме добавления/удаления выберите предметы и нажмите «⏹ Прекратить».\n"
